...
class ProfilDay33 extends StatefulWidget {
//   final LoginModel user;
  ProfilDay33({super.key});

  @override
  _ProfilDay33State createState() => _ProfilDay33State();
}

class _ProfilDay33State extends State<ProfilDay33> {
  ...
  // Edit Profil
  Future<void> _editProfile(ProfilData user) async {
      ...
      child: Column(
        ...
        children: [
          ...
          FutureBuilder(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                _buildInfoUserAccount(user),

        //Edit
        _buildEditBottom(user),
                ],
                );
            },
            ),
        ...
        Container(
          ...
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                Color.fromARGB(255, 189, 194, 221).withOpacity(0.3),
                Color.fromARGB(255, 16, 56, 175).withOpacity(0.3),
              ],
            ),
          ...
          child: Icon(Icons.person, color: Color.fromARGB(255, 255, 255, 255), size: 24),
        ),
        width(12),
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
...
Widget _buildInfoUserAccount(ProfilData user) {
  return Column(
    children: [
      _buildInfoItem(
...
Widget _buildEditBottom(ProfilData user) {
  return Row(
    ...
    return Center(
      child: Column(
        children: [
          Text(
            'Versi 1.0.0',
            style: TextStyle(color: const Color.fromARGB(255, 207, 207, 207), fontSize: 12),
          ),
          height(5),
          Text(
            'Copyright 2025 stuntinQ.',
            style: TextStyle(color: const Color.fromARGB(255, 207, 207, 207), fontSize: 11),
          ),
          Text(
            'All right reserved.',
            style: TextStyle(color: const Color.fromARGB(255, 207, 207, 207), fontSize: 11),
